...
@Table(name = "DR_CARD_LAWLESS")
public class DrCardLawless implements Serializable {
    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy = GenerationType.IDENTITY, generator = "select SEQ_DR_CARD_LAWLESS_ID.nextval from dual")
    private Integer id;
