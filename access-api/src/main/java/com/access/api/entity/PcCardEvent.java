...
@Table(name = "PC_CARD_EVENT")
public class PcCardEvent implements Serializable {
    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy = GenerationType.IDENTITY, generator = "select SEQ_PC_CARD_EVENT_ID.nextval from dual")
    private Integer id;
     ...
     * @param attmode
     */
    public void setAttmode(Integer attmode) {
    ...
    public String toString() {
        ...
        sb.append(", attmode=").append(attmode);
